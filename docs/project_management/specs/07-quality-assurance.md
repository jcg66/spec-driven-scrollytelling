...
- Browser tests must run against a production-like build for critical flows.
...
- Test suites map clearly to the risks in the scrollytelling experience instead of existing as generic smoke coverage only.
